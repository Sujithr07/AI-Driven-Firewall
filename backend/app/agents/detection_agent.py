...
from app.federation.fl_client import FLClient
from app.core.config import MODELS_DIR as _MODELS_DIR
...
try:
    from app.ml.detection.lstm_detector import LSTMDetector
    LSTM_AVAILABLE = True
except ImportError:
...
class TrafficClassifier:
    ...
    def _load_or_init(self):
        ...
        import shutil
        seed_path = os.path.join(_MODELS_DIR, "rf_model_seed.pkl")
...
class XGBoostClassifier:
    ...
    MODEL_PATH = os.path.join(_MODELS_DIR, "xgb_model.pkl")
...
class DQNAgent:
    ...
    ACTIONS = ["allow", "block"]
    MODEL_PATH   = os.path.join(_MODELS_DIR, "dqn_model.pt")
    Q_TABLE_PATH = os.path.join(_MODELS_DIR, "q_table.json")
